...
class MrpcProcessor(DataProcessor):
    ...
    def get_test_examples(self, sentence):
        ...
        return self._create_test_examples(sentence)
    ...
    def _create_test_examples(self, sentence):
        """Creates examples for predict"""
        examples = []
        labels = []
        text_a = tokenization.convert_to_unicode(sentence)
        labels.append(1)
        examples.append(InputExample(guid="test-1", text_a=text_a, text_b=None, label=1))
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        per_example_loss = -tf.reduce_sum(one_hot_labels * log_probs, axis=-1, name='example_loss')
...
def main(_):
    ...
    return processor, tokenizer, label_list, predict_file


def getinput(processor, tokenizer, predict_file, sentence):
    sentence = sentence
    predict_examples, placeholder_labels = processor.get_test_examples(sentence)
    ...
    file_based_convert_examples_to_features(predict_examples, label_list_test,
